  ...
  features = [
    {
      ...
      description:
        "Drag and drop components to create complex LLM workflows without writing code.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Access a wide range of pre-built components for LLMs, embeddings, vector stores, and more.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
