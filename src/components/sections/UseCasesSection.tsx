...
const UseCasesSection = ({
  ...
  useCases = [
    ...
    },
    {
      ...
      description:
        "Generate high-quality content for marketing, documentation, or creative purposes.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
    ...
    },
    {
      title: "Data Analysis",
      description:
        "Extract insights and analyze large volumes of text data to identify patterns and trends.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Create intelligent knowledge bases that can answer questions based on your organization's data.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Automate customer support with intelligent systems that can understand and resolve issues.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Accelerate R&D processes by automating literature reviews and generating research hypotheses.",
      icon: (
        <svg
          className="w-10 h-10 text-purple-500"
          fill="none"
